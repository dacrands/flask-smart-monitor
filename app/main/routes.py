...
from app.main.forms import TodoForm, StockForm, EmbedForm, LocationForm
...
@bp.route('/settings/<stock>', methods=['GET', 'POST'])
@login_required
...
# TODO Use DELETE instead of POST
@bp.route('/settings/todo/<todo_id>', methods=['GET', 'POST'])
@login_required
...
# TODO Use DELETE instead of POST
@bp.route('/settings/embed/<embed_code>', methods=['GET', 'POST'])
@login_required
